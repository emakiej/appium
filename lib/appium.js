...
Appium.prototype.getDeviceFromMJSONWP = function (args, caps) {
  ...
  var type =  this.getDeviceTypeFromAutomationNameAndBrowserName(automation, browser) ||
...
Appium.prototype.getDeviceTypeFromAutomationNameAndBrowserName = function (automation, browser) {
  if (browser === "opera") {
    return DT_OPERA;
  }
  if (automation.indexOf('selendroid') !== -1){
